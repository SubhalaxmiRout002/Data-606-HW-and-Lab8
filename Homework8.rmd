...
<span style="color: #354260">
$(a)$ The relationship between number of calories and amount of carbohydrates is positively correlated. </br>
</span>

<span style="color: #354260">
$(b)$ In this scinario, the amount of carbohydrates is the response and calories is the explanatory variable.
</span>

<span style="color: #354260">
$(c)$ We would want to fit a regression line to these data to calculate the number of carbohydrates in an item by knowing the number of calories.</br>
</span>

<span style="color: #354260">
$(d)$ Yes, the data meets the conditions required for fitting a least squares line.</br>
</span>

<span style="color: #354260">
**Linearty: **The data seems to linear </br>
</span>

<span style="color: #354260">
**Nearly normal residuals: ** The residuals seems normal distribution but slightly left skewed.</br>
</span>

<span style="color: #354260">
**Constant variability: ** This appears to be roughly the same degree of residuals above and below the horizonal line, suggesting constant variability.
</span>
...
<span style="color: #354260">
$(a)$ Shoulder girth and Height are positively correlated with each other. </br>
</span>
...
<span style="color: #354260">
$(a)$ The equation for the regression line is y = mx + c </br>
where y = predicted values </br>
      m = slope </br>
      c = intercept </br>
</span>
...
<span style="color: #354260">
$(e)$ A residual means the difference between the observed and predicted value of the response variable. </br>
There are 2 types of residuals</br>
1. Positive residuals </br>
2. Negative residuals </br>
</span>
...
<span style="color: #354260">
$(a)$ Linear model y = mx + c </br>
Here m = 4.043 </br>
      c = -0.357 </br>
    heart weight = 4.043 * body weight - 0.357 </br>
</span>

<span style="color: #354260">
$(b)$ At a body weight of 0 kg we would expect a heart weight of -0.357 gm. 0 body weight and -0.357g heart weight is quite impossible. So the intercept serves only to set the height of the line in the model.
</span>

<span style="color: #354260">
$(c)$  The model predicts an additional 4.043 gm in heart weight for each additional kg in body.
</span>

<span style="color: #354260">
$(d)$ 64.66% of the variability in heart weight is explained by body weight in this model.
</span>

<span style="color: #354260">
$(e)$ Correlation coefficient = square root of (R^2)
</span>

```{r}
r <- round(sqrt(0.6466),3)
paste0("The corelation coefficient is ", r)
```
...
<span style="color: #354260">
$(b)$ The value of slope is 0.133 (positive). So we can conclude that this data shows convincing evidance of the slope being positive. This product will never be negative. 
</span>

<span style="color: #354260">
$(c)$ Conditions for linear regression: </br>
</span>

<span style="color: #354260">
**Linearity:** There seems to be some trend on the scatterplot, so we can confirm linearity.</br>
</span>

<span style="color: #354260">
**Normal Residuals:** The Histogram and qqplot shows that the residuals appear to be normal with  slight left skewed.</br>
</span>

<span style="color: #354260">
**Constant Variability: ** Residual plot confirms this.</br>
